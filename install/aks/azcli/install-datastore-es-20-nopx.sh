...
helm --kubeconfig=${KC} upgrade --wait --timeout=600 --install --values ../datastore/elasticsearch/master-values-nopx.yaml datastore-elasticsearch-master ../datastore/elasticsearch
helm --kubeconfig=${KC} upgrade --wait --timeout=600 --install --values ../datastore/elasticsearch/client-values-nopx.yaml datastore-elasticsearch-client ../datastore/elasticsearch
